  ...
  useEffect(() => {
    ...
    const fetchTrailer = async () => {
      try {
        ...
        console.error('Error fetching trailer for details modal:', err)
      }
    }
              ...
              {playTrailer && trailerId ? (
                <div className="absolute inset-0 w-full h-full bg-black z-20">
                  ...
                  <Button
                    ...
                    className="absolute top-4 left-4 z-30 text-white bg-black/60 hover:bg-black/80 rounded-full w-10 h-10 p-0 flex items-center justify-center border border-white/10"
                  >
                    <X className="w-5 h-5" />
                  </Button>
                </div>
