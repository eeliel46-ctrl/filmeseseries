...
export const CHANNELS_DATA: Channel[] = [
  // ==================== CANAIS ABERTOS ====================
  {
    ...
    number: '05',
    category: 'abertos',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Logotipo_da_TV_Globo.svg/512px-Logotipo_da_TV_Globo.svg.png',
    quality: '1080p',
    description: 'Principal emissora do Brasil com novelas, jornalismo factual, BBB, entretenimento e futebol ao vivo.',
    currentProgram: 'Programação Nacional & Futebol Ao Vivo',
    tags: ['Aberto', 'Novelas', 'Futebol', 'Jornalismo', 'Globo'],
    isFeatured: true,
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=globo-sp',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (SuperFlix)',
        url: 'https://superflixapi.sbs/tv/globo-sp',
        type: 'iframe',
      },
      {
        name: 'Servidor 3 (Alternativo)',
  ...
  },
  {
    ...
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Logotipo_da_TV_Globo.svg/512px-Logotipo_da_TV_Globo.svg.png',
    quality: '1080p',
    description: 'Transmissão da TV Globo Rio de Janeiro com foco no Campeonato Carioca e jornalismo regional.',
    currentProgram: 'RJ TV & Campeonato Carioca',
    tags: ['Aberto', 'Rio de Janeiro', 'Futebol', 'Globo'],
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=globo-rj',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
        url: 'https://megacanais.com/embed/globo-rj',
        type: 'iframe',
      },
    ],
  },
  {
    ...
    number: '04',
    category: 'abertos',
    logo: 'https://upload.wikimedia.org/wikipedia/pt/thumb/9/92/Logotipo_do_SBT.svg/512px-Logotipo_do_SBT.svg.png',
    quality: '1080p',
    description: 'Sistema Brasileiro de Televisão: programas de auditório, novelas infantis, Champions League e variedades.',
    currentProgram: 'Programa Silvio Santos & Champions League',
    tags: ['Aberto', 'Auditório', 'Desenhos', 'SBT'],
    isFeatured: true,
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
  ...
  },
  {
    ...
    number: '07',
    category: 'abertos',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Record_TV_logo_2023.svg/512px-Record_TV_logo_2023.svg.png',
    quality: '1080p',
    description: 'Jornalismo factual, novelas consagradas, realities shows como A Fazenda e Paulistão.',
    currentProgram: 'Jornal da Record & Paulistão Ao Vivo',
  ...
  },
  {
    ...
    number: '13',
    category: 'abertos',
    logo: 'https://upload.wikimedia.org/wikipedia/pt/thumb/c/cb/Logotipo_da_Rede_Bandeirantes.svg/512px-Logotipo_da_Rede_Bandeirantes.svg.png',
    quality: '1080p',
    description: 'Rede Bandeirantes: Fórmula 1, Jogo Aberto, MasterChef Brasil, esportes e jornalismo dinâmico.',
    currentProgram: 'Fórmula 1 & Jogo Aberto',
    tags: ['Aberto', 'Fórmula 1', 'Futebol', 'Band'],
    isFeatured: true,
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
  ...
  },
  {
    ...
    number: '02',
    category: 'abertos',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Logotipo_da_TV_Cultura.svg/512px-Logotipo_da_TV_Cultura.svg.png',
    quality: '1080p',
    description: 'Referência em educação, Roda Viva, programas infantis premiados e transmissões culturais.',
    currentProgram: 'Roda Viva & Cultura Clássica',
    tags: ['Aberto', 'Educativo', 'Debates', 'Cultura'],
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=tvcultura',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '09',
    category: 'abertos',
    logo: 'https://upload.wikimedia.org/wikipedia/pt/thumb/c/c9/RedeTV%21_logo_2018.svg/512px-RedeTV%21_logo_2018.svg.png',
    quality: '720p',
    description: 'Entretenimento, esportes, NFL, SuperPop e programas jornalísticos ao vivo.',
    currentProgram: 'NFL & Entretenimento',
    tags: ['Aberto', 'NFL', 'Variedades'],
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=redetv',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  // ==================== ESPORTES ====================
  {
    ...
    number: '39',
    category: 'esportes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/SporTV_logo_2021.svg/512px-SporTV_logo_2021.svg.png',
    quality: '1080p',
    ...
    tags: ['Esporte', 'Futebol', 'SporTV', 'Ao Vivo'],
    isFeatured: true,
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=sportv',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (SuperFlix)',
  ...
  },
  {
    ...
    number: '38',
    category: 'esportes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/SporTV_2_logo_2021.svg/512px-SporTV_2_logo_2021.svg.png',
    quality: '1080p',
    description: 'Transmissões esportivas simultâneas, automobilismo, basquete NBB e atletismo.',
  ...
  },
  {
    ...
    number: '37',
    category: 'esportes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/SporTV_3_logo_2021.svg/512px-SporTV_3_logo_2021.svg.png',
    quality: '1080p',
    description: 'Esportes radicais, tênis mundial, surfe WSL e eventos internacionais ao vivo.',
    currentProgram: 'Tênis ATP & Surfe WSL',
  ...
  },
  {
    ...
    number: '60',
    category: 'esportes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Premiere_logo_2021.svg/512px-Premiere_logo_2021.svg.png',
    quality: '4K',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=premiere-clubes',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (SuperFlix)',
  ...
  },
  {
    ...
    tags: ['Esporte', 'Premier League', 'Libertadores', 'ESPN'],
    isFeatured: true,
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=espn-brasil',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=espn2',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '75',
    category: 'esportes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Bandsports_2018.png/512px-Bandsports_2018.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '77',
    category: 'esportes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/TNT_Logo_2016.svg/512px-TNT_Logo_2016.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '110',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Telecine_logo_2021.svg/512px-Telecine_logo_2021.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=telecine-premium',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (SuperFlix)',
  ...
  },
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=telecine-action',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=telecine-pipoca',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=telecine-touch',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=telecine-cult',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '120',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Megapix_logo_2021.svg/512px-Megapix_logo_2021.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '130',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Warner_Channel_logo_2017.svg/512px-Warner_Channel_logo_2017.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '135',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Universal_TV_logo_2018.svg/512px-Universal_TV_logo_2018.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '140',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Sony_Channel_logo_2019.svg/512px-Sony_Channel_logo_2019.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '145',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Space_logo_2020.svg/512px-Space_logo_2020.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '150',
    category: 'filmes',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Paramount_Network_logo_2018.svg/512px-Paramount_Network_logo_2018.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=paramount',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  // ==================== NOTÍCIAS ====================
  {
    ...
    number: '40',
    category: 'noticias',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/GloboNews_logo_2021.svg/512px-GloboNews_logo_2021.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '577',
    category: 'noticias',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/CNN_Brasil_logo.svg/512px-CNN_Brasil_logo.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=cnn-brasil',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '576',
    category: 'noticias',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Jovem_Pan_News_logo.svg/512px-Jovem_Pan_News_logo.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=jovempannews',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  // ==================== INFANTIL ====================
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=cartoon-network',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (SuperFlix)',
  ...
  },
  {
    ...
    number: '205',
    category: 'infantil',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Discovery_Kids_logo_2021.svg/512px-Discovery_Kids_logo_2021.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=discovery-kids',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '210',
    category: 'infantil',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Nickelodeon_2023_logo.svg/512px-Nickelodeon_2023_logo.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=nickelodeon',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '215',
    category: 'infantil',
    logo: 'https://upload.wikimedia.org/wikipedia/pt/thumb/d/d7/Logotipo_do_Gloob.svg/512px-Logotipo_do_Gloob.svg.png',
    quality: '1080p',
  ...
  // ==================== DOCUMENTÁRIOS & VARIEDADES ====================
  {
    ...
    number: '300',
    category: 'variedades',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Discovery_Channel_2019_logo.svg/512px-Discovery_Channel_2019_logo.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=discovery-channel',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (SuperFlix)',
  ...
  },
  {
    ...
    number: '310',
    category: 'variedades',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/National_Geographic_Logo.svg/512px-National_Geographic_Logo.svg.png',
    quality: '1080p',
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=national-geographic',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    servers: [
      {
        name: 'Servidor 1 (Ultra HD)',
        url: 'https://sinalpublico.com/player3/ch.php?canal=animal-planet',
        type: 'iframe',
      },
      {
        name: 'Servidor 2 (Alternativo)',
  ...
  },
  {
    ...
    number: '320',
    category: 'variedades',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Multishow_logo_2021.svg/512px-Multishow_logo_2021.svg.png',
    quality: '1080p',
  ...
  },
  {
    ...
    number: '330',
    category: 'variedades',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Canal_Viva_logo_2021.svg/512px-Canal_Viva_logo_2021.svg.png',
    quality: '1080p',
